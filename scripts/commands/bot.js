...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("এত হাই-হ্যালো না দিয়ে আমার বস শাহেদকে একটা জিএফ দে..!🍆⛏️🐸", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "shahed vai") || (event.body.toLowerCase() == "শাহেদ ভাই") || (event.body.toLowerCase() == "শাহেদ") || (event.body.toLowerCase() == "shahed")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞𝐒𝐇𝐀𝐇𝐄𝐃 (✷‿✷)☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐓𝐎𝐌.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61551855032471\nতার সাতে যোগা যোগ করবেন WhatsApp :- +88013061090**", threadID);
   };

   if ((event.body.toLowerCase() == "tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:𝐒𝐇𝐀𝐇𝐄𝐃  ❤️/n হাই আমি মেছেন্জার ROBOT  আামার বস শাহেদ আমাকে আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য/n আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "adbmin") || (event.body.toLowerCase() == "bolr admin")) {
     return api.sendMessage("He is 𝐌𝐀𝐓𝐀 𝐒𝐇𝐀𝐇𝐄𝐃 ❤️/n তাকে সবাই 𝐒𝐇𝐀𝐇𝐄𝐃(✷‿✷)নামে  চিনে🤙", threadID);
   };

   if ((event.body.toLowerCase() == "vabi") || (event.body.toLowerCase() == "vabi")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "salam ")) {
   ...
   if ((event.body.toLowerCase() == "dhur") || (event.body.toLowerCase() == "baler robot") || (event.body.toLowerCase() == "shahed ami") || (event.body.toLowerCase() == "opoman korli")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "lija") || (event.body.toLowerCase() == "লিজা ")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস শাহেদ এর বেষ্টুর এর নাম..!😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে আমার বস শাহেদ গার্লফ্রেন্ড  দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "শিশির") || (event.body.toLowerCase() == "shamim")) {
     return api.sendMessage("️এরা আমার বস শাহেদের ফ্রেন্ড", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Mariom") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️ আমার বস শাহেদের Ex হলো ১২ ভাতারি😤💔", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "AMAKE KEW VALOBASHE NA") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন আমার বস তো আছে🫶/nতোমাকে অনেক ভালোবাসবে", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে আমার বস শাহেদের ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("হুম আমার বস শাহেদ ও তেমাকে ভালোবাসে🥰🥱", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami shahed") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("হ্যাঁ শাহেদ কলিজা ভালো আছো ভাবি কেমন আছে?", threadID);
   };
   mess = "{name}"
